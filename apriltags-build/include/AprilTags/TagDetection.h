...
struct TagDetection {
  ...
  */
  Eigen::Matrix4d getRelativeTransform(double tag_size, double cube_size, double fx, double fy,
  ...
  void getRelativeTranslationRotation(double tag_size, double cube_size, double fx, double fy, double px, double py,
