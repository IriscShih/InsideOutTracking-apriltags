...
//   objPts.push_back(cv::Point3f(-s,-s, 0));
  ...
  //cv::Vec4f distParam(0,0,0,0); // all 0?
    ...
    //distParam.at<float>(0) = -0.3127;
    //distParam.at<float>(1) =  0.1356;
    //distParam.at<float>(2) =  0.0;
    //distParam.at<float>(3) =  0.0;
    //distParam.at<float>(4) = -0.0285;
    
  cv::Mat distParam(4,1,CV_32F);
    distParam.at<float>(0) =  0.1067;
    distParam.at<float>(1) = -0.4792;
    distParam.at<float>(2) =  0.0;
    distParam.at<float>(3) =  0.0;
